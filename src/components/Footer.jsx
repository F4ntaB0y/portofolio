    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/F4ntaB0y"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/aryapangestu23/"><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://www.youtube.com/@muh.aryapangestu6388"><i className="ri-youtube-fill ri-2x"></i></a>
        </div>
      ...
      <p className="mt-10 font-bold text-zinc-500 text-sm">
        Deployed by: Muh. Arya Pangestu - 2388010003
      </p>
    </div>
  );
};
