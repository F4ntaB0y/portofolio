        ...
        <div className="hero grid lg:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              ...
              <q>Still code and still yoman🤙🏻</q>
            </div>
            <h1 className="text-3xl sm:text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Muh. Arya Pangestu" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="A 6th-semester Informatics student with a relentless curiosity for emerging technologies. I combine academic foundations with hands-on experience in modern frameworks to build efficient, user-centric solutions."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
            ...
            <div className="flex flex-wrap items-center sm:gap-4 gap-3">
              <a
                href="./assets/CV.pdf"
                download="Muh_Arya_Pangestu_CV.pdf"
                className="font-semibold bg-[#1a1a1a] p-3 sm:p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors text-sm sm:text-base"
              >
                <ShinyText text="Download CV" disabled={false} speed={3} className="custom-class" />
              </a>

              <a href="#project" className="font-semibold bg-[#1a1a1a] p-3 sm:p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors text-sm sm:text-base">
          ...
          <div className="lg:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              ...
              handle="aryapangestu23"
              status="Online"
              contactText="Contact Me"
              avatarUrl="./assets/estu.png"
              showUserInfo={true}
              enableTilt={true}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10 pt-0 px-2 sm:px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full lg:basis-7/12 pr-0 lg:pr-8 border-b lg:border-b-0 lg:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I’m Muh. Arya Pangestu, a 6th-semester Informatics student and an aspiring developer passionate about building modern, high-performance applications. I bridge the gap between academic foundations and real-world implementation. I thrive on turning complex logic into intuitive user experiences, blending creativity with technical precision. Whether it's developing AI-driven solutions or crafting seamless cross-platform apps, I am committed to delivering functional, aesthetic, and scalable digital products that solve real-world problems."
                  delay={150}
                  animateBy="words"
                  direction="top"
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  <div>
                    <h1 className="text-3xl md:text-4xl mb-1">
                      Active<span className="text-violet-500"> </span>
                    </h1>
                    <p>Informatics Student.</p>
                  </div>
                  <div>
                    <h1 className="text-3xl md:text-4xl mb-1">
                      500<span className="text-violet-500">+</span>
                    </h1>
                    <p>Coding Hours.</p>
                  </div>
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      3.83<span className="text-violet-500">/4.00</span>
                    </h1>
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.co/d4933efd7d02d8814c93ec34a9a02549"
                method="POST"
